                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              '${FlutterMoneyFormatter(amount: opening).formattedNonSymbol} L.L',
                              style:
                      ...
                      children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: FutureBuilder(
                                  builder: (BuildContext context,
                                    ...
                                    return Center(
                                      child: Text(
                                        'In  : ${FlutterMoneyFormatter(amount: qttnumbr.data).formattedNonSymbol} L.L',
                                        style: TextStyle(
                            ...
                            Padding(
                              ...
                              child: FutureBuilder(
                                  builder: (BuildContext context,
                                    ...
                                    return Center(
                                      child: Text(
                                        'Out  : ${FlutterMoneyFormatter(amount: qttnumbr.data).formattedNonSymbol} L.L',
                                        style: TextStyle(
                                            color: Colors.black, fontSize: 18),
                                      ),
                                    );
                        ...
                        FutureBuilder(
                            builder: (BuildContext context,
                              ...
                              return Center(
                                child: Text(
                                  'Tolal  : ${FlutterMoneyFormatter(amount: qttnumbr.data).formattedNonSymbol} L.L',
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20),
                      ...
                      children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: FutureBuilder(
                                  builder: (BuildContext context,
                                    ...
                                    return Center(
                                      child: Text(
                                        'In  : ${FlutterMoneyFormatter(amount: qttnumbr.data).formattedNonSymbol} \$',
                                        style: TextStyle(
                                            color: Colors.black, fontSize: 18),
                                      ),
                                    );
                            ...
                            Padding(
                              ...
                              child: FutureBuilder(
                                  builder: (BuildContext context,
                                    ...
                                    return Center(
                                      child: Text(
                                        'Out  : ${FlutterMoneyFormatter(amount: qttnumbr.data).formattedNonSymbol} \$',
                                        style: TextStyle(
                                            color: Colors.black, fontSize: 18),
                                      ),
                                    );
                        ...
                        FutureBuilder(
                            builder: (BuildContext context,
                              ...
                              return Center(
                                child: Text(
                                  'Tolal  : ${FlutterMoneyFormatter(amount: qttnumbr.data).formattedNonSymbol} \$',
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20),
...
//                                                                          'omt')
//                                                                      .document(
//                                                                          '${OMTScreen.transaction[index]['id']}')
//                                                                      .delete();
//                                                                  gettransaction();
//                                                                  OMTScreen
//                                                                      .transaction
...
//                                                    child: ListTile(
//                                                      title: Text(
//                                                        '${formatDate(DateTime.parse(OMTScreen.transaction[index]['time'].toDate().toString()), [
//                                                          yyyy,
//                                                          '-',
//                                                          mm,
//                                                          '-',
...
//                                                                      .all(8.0),
//                                                              child: Text(
//                                                                '${OMTScreen.transaction[index]['in'].toString()}',
//                                                                style: TextStyle(
//                                                                    color: Colors
//                                                                        .green,
//                                                                    fontSize:
...
//                                                                      .all(8.0),
//                                                              child: Text(
//                                                                '${OMTScreen.transaction[index]['out'].toString()}',
//                                                                style: TextStyle(
//                                                                    color: Colors
//                                                                        .red,
//                                                                    fontSize:
                ...
                Center(
                  child: FutureBuilder(
                      builder: (BuildContext context,
                        ...
                        return Center(
                          child: Text(
                            'Total : ${FlutterMoneyFormatter(amount: qttnumbr.data).formattedNonSymbol} L.L',
                            style: TextStyle(color: Colors.black, fontSize: 18),
                          ),
                        );
                      },
                      initialData: 1.0,
                      future: getsumsum(startDate, 'L.L.')),
                ),
