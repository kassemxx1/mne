...
class _RechargeScreenState extends State<RechargeScreen> {
  ...
  void getPhonesList() async {
    ListOfPhones.clear();
    final messages = await _firestore.collection('phones').where('categories',isEqualTo: 'recharge').getDocuments();
                                            ...
                                            children: <Widget>[
                                              ...
                                              Padding(
                                                ...
                                                child: MaterialButton(
                                                  ...
                                                  onPressed: () {
                                                    if (ListOfPhones[index]['phonename']=='alfa Days' || ListOfPhones[index]['phonename']=='mtc Days' ){
                                                      if(ListOfPhones[index]['phonename']=='alfa Days'){
                                                        _firestore
                                                            .collection(
                                                            'transaction')
                                                            .add({
